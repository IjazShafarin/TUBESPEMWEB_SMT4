        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="form-group-mb-3">
                    ...
                    class="form-control" id="tgl_lahir" value=" <?= $pasien ['tgl_lahir'] ?>" required>
                </div>
                ...
                <div class="form-group-mb-3">
                    ...
                    <div>
                        <div class="form-check form-check-inline">
                            ...
                            value="P" required <?= ($pasien ['gender'] == 'p') ? 'checked' : '';  ?> >
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" 
                            type="radio" name="gender" id="gender" 
                            value="W" <?= ($pasien ['gender'] == 'W') ? 'checked' : '';  ?>>
